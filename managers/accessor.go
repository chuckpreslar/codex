...
func (self Accessor) AddColumn(name string, typ sql.Type, arguments ...sql.Constraint) {}
func (self Accessor) AddConstraint(column string, constraint sql.Constraint)           {}
func (self Accessor) Drop()                                                            {}
